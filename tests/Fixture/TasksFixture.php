...
class TasksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'assumption_time' => ['type' => 'string', 'length' => 10, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'real_time' => ['type' => 'string', 'length' => 10, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'assumption_time' => 'Lorem ip',
                'real_time' => 'Lorem ip',
                'status_id' => 1,
                'project_id' => 1,
                'personnel_id' => 1,
                'is_delete' => 1,
                'create_at' => '2021-02-21 00:02:51',
                'update_at' => '2021-02-21 00:02:51',
                'add_user_id' => 1,
                'add_update_id' => 1
            ],
        ];
