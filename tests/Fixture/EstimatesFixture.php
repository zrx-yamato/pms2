...
class EstimatesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'document' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null],
        ...
        'update_user_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'status_id' => 1,
                'is_delete' => 1,
                'create_at' => '2021-02-21 00:02:53',
                'update_at' => '2021-02-21 00:02:53'
            ],
        ];
        parent::init();
    }
