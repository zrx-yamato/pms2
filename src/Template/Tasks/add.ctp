...
<div class="tasks form large-9 medium-8 columns content">
    ...
    <fieldset>
        <?php
            ...
            echo $this->Form->control('status_id', ['options' => $statuses, 'label' => 'ステータス', 'class' => 'form-control']);
            echo $this->Form->control('project_id', ['options' => $projects, 'label' => 'プロジェクト名', 'class' => 'form-control']);
            echo $this->Form->control('personnel_id', ['options' => $personnels, 'label' => '担当者', 'class' => 'form-control']);
        ?>
    </fieldset>
